...
;(function (window, document) {
  ...
  function renderStewardPanelContent() {
    ...
    var adminHtml = '' +
      ...
      '    <span style="font-size:11px; color:var(--nbf-mut);">Garage diagnostics and future management tools</span>' +
      '  </div>' +
    ...
    panelHtml += '<p style="margin:4px 0 0 0; font-size:12px; color:var(--nbf-mut); line-height:1.5;">Admin and Steward operations live here. Daily race actions stay visible; non-daily tools stay folded until needed.</p>';
    panelHtml += '</div>';
    panelHtml += adminHtml;
